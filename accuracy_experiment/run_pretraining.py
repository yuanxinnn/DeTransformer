...
import modeling_split as modeling
...
def prepare_model_and_optimizer(args, device, sequence_output_is_dense):
    ...
    # config = modeling.DeBertConfig.from_json_file(args.config_file)
    ...
    # model = modeling.DeBertForPreTraining(config, sequence_output_is_dense=sequence_output_is_dense)
...
def main():
    ...
    print('args.input_dir = '+str(args.input_dir))
